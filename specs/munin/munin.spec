...
Source0: http://downloads.sourceforge.net/sourceforge/munin/munin-%{version}.tar.gz
Source1: munin-1.2.5-hddtemp_smartctl-config
Source2: munin-1.2.4-sendmail-config
Source3: munin.te
Patch1: munin-1.4.2-conf.patch
...
%changelog
* Wed Dec 23 2009 Steve Huff <shuff@vecna.org> - 1.4.2-1
- Updated to version 1.4.2.

* Thu Sep 03 2009 Steve Huff <shuff@vecna.org> - 1.2.6-2
