...
%changelog
* Thu Oct 25 2012 Dag Wieers <dag@wieers.com> - 4.4.0-1
- Updated to release 4.4.0.

* Wed Aug 01 2012 Dag Wieers <dag@wieers.com> - 4.3.8-1
- Updated to release 4.3.8.

* Fri Jun 08 2012 Dag Wieers <dag@wieers.com> - 4.3.7-1
- Updated to release 4.3.7.

* Sun Apr 08 2012 Dag Wieers <dag@wieers.com> - 4.3.6-1
- Updated to release 4.3.6.

* Wed Jan 25 2012 Dag Wieers <dag@wieers.com> - 4.3.5-1
- Updated to release 4.3.5.

* Sun Jan 22 2012 Dag Wieers <dag@wieers.com> - 4.3.4-1
- Updated to release 4.3.4.
