...
%{!?_rpmhome:%global _rpmhome /usr/lib/rpm/5.0}

%define	__prefix	%{?_prefix}%{!?_prefix:/usr}
%{?!_lib: %define _lib lib}
%{expand: %%define __share %(if [ -d %{__prefix}/share/man ]; then echo /share ; else echo %%{nil} ; fi)}

%define rpm_release 0.2
...
%changelog
* Tue Aug 28 2007 Dries Verachtert <dries@ulyssis.org> - 5.0-0.2.0
...
- jbj: populate /usr/lib/rpm/5.0/ instead of foo-5.0 files.
