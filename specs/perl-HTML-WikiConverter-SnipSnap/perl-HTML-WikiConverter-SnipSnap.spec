...
%define real_name HTML-WikiConverter-SnipSnap

Summary: Converts HTML to SnipSnap markup
Name: perl-HTML-WikiConverter-SnipSnap
Version: 0.50
Release: 1%{?dist}
License: Artistic/GPL
Group: Applications/CPAN
URL: http://search.cpan.org/dist/HTML-WikiConverter-SnipSnap/

Source: http://www.cpan.org/modules/by-module/HTML/HTML-WikiConverter-SnipSnap-%{version}.tar.gz
