...
%define real_name HTML-WikiConverter-TikiWiki

Summary: Converts HTML to TikiWiki markup
...
Source: http://www.cpan.org/modules/by-module/HTML/HTML-WikiConverter-TikiWiki-%{version}.tar.gz
