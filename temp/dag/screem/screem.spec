...
%install
%{__rm} -rf %{buildroot}
%{__perl} -pi.orig -e 's|/usr/share|\$\(datadir\)|g' pixmaps/Makefile
export GCONF_DISABLE_MAKEFILE_SCHEMA_INSTALL="1"
%makeinstall \
	Applicationsdir="%{buildroot}%{_datadir}/gnome/apps/Development"
%find_lang %{name}
...
%changelog
* Thu Sep 18 2003 Dag Wieers <dag@wieers.com> - 0.8.1-0
- Updated to release 0.8.1.

* Mon Sep 15 2003 Dag Wieers <dag@wieers.com> - 0.8.0-0
